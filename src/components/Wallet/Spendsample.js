...
const Spend = ({ instance }) => {
    // const [spendTo, setSpendTo] = useState('');
		const spendTo = "ak_VfYAqeatjV6jgLf2QLZ38yxK19PYqxFnqp81qwdUWasriqe6u" ; 
    ...
    return (
        <div className="max-w-md mx-auto bg-white p-6 rounded-md shadow-md">
            ...
            <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2">Enter Price</label>
                <input
                    className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    value={spendAmount}
            ...
            {/* <div className="mb-4">
                ...
                />
						...
						<div>
						<label className="block text-gray-700 text-sm font-bold mb-2">Enter your Dish name</label>
						<input
                    className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                />
						</div>
